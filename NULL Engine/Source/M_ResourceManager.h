...
public:																								// --- RESOURCE MANAGER API ---
	...
	void			GetAllScripts(std::map<std::string, std::string>& scripts);	//Retrive all available scripts from library

	void			GetAllTextures(std::vector<R_Texture*>& textures);									//Retrieve all the textures in the library
