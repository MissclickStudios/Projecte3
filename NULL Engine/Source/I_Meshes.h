...
namespace Importer
{
	namespace Meshes
	{
		...
		namespace Utilities
		{
			...
			void SaveBoneMapping (char** cursor, const R_Mesh* rMesh);									// Stores the given bone's name in the given buffer.
			void SaveBoneOffset	(char** cursor, const R_Mesh* rMesh);									// Stores the given bone's offset matrix in the given buffer
