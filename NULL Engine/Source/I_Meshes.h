...
namespace Importer
{
	namespace Meshes
	{
		...
		uint Save(const R_Mesh* rMesh, char** buffer);															// Processes R_Mesh data into ready-to-save buffer. Will rt the buffer's size.
		bool Load(const char* buffer, R_Mesh* rMesh);															// Processes buffer data into a ready-to-use R_Mesh. Will rt nullptr on ERROR.
